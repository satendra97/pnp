...
import {IPnPspcrudWebPartProp} from './IPnPspcrudWebPartProp';
...
export interface ISPList {
  ...
  export default class PnPspcrudWebPart extends BaseClientSideWebPart<IPnPspcrudWebPartProp> { 
    ...
    private _getListData(): Promise<ISPList[]> {
      ...
      <p class="ms-font-l ms-fontColor-white" style="text-align: left">Demo for Framework : SharePoint List CRUD using PnP JS and SPFx</p>
      </div>
      </div>
      <div class="ms-Grid-row ms-bgColor-themeDark ms-fontColor-white ${styles.row}">
